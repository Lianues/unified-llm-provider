...
export class LLMRouter {
  ...
  async chat<TOutput = LLMResponse>(request: unknown, modelName?: LLMModelName, options?: LLMCallOptions): Promise<TOutput> {
    return this.resolve(modelName).chat<TOutput>(request, options);
  }
